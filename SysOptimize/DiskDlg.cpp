...
BEGIN_MESSAGE_MAP(CDiskDlg, CDialog)
    ...
    ON_WM_CTLCOLOR()
    //}}AFX_MSG_MAP
    ON_STN_CLICKED(IDC_STATEXT, &CDiskDlg::OnStnClickedStatext)
    ON_NOTIFY(LVN_ITEMCHANGED, IDC_LIST1, &CDiskDlg::OnLvnItemchangedList1)
END_MESSAGE_MAP()
...
void CDiskDlg::OnStnClickedStatext()
{
    // TODO: 在此添加控件通知处理程序代码
}


void CDiskDlg::OnLvnItemchangedList1(NMHDR* pNMHDR, LRESULT* pResult)
{
